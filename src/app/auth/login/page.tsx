    ...
    <div className="w-full max-w-md">
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-8 shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {/* Password */}
          <div className="space-y-2">
            <Label htmlFor="password" className="text-gray-700 dark:text-gray-300 font-inter font-medium">
              Password
            </Label>
            <div className="relative">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className="text-sm text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium font-inter"
            >
              Forgot password?
            </Link>
          </div>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white dark:bg-gray-900 text-gray-500 dark:text-gray-400 font-inter">
              Or continue with
            </span>
          </div>
        </div>
        ...
        <Button
          variant="outline"
          className="w-full h-12 border-2 border-gray-300 dark:border-gray-600 hover:border-slate-900 dark:hover:border-white hover:bg-slate-900 dark:hover:bg-white hover:text-white dark:hover:text-slate-900 rounded-xl font-inter font-medium"
          disabled={loading}
        >
